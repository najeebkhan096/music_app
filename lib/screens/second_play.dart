...
class Second_Parent_Play_Screen extends StatefulWidget {
  List<AudioTrack>? songs_list;
  int? current_index;
  int? hive_index;
  bool ? status;
  Second_Parent_Play_Screen({this.songs_list, this.current_index, this.hive_index,this.status});
  static const routename = "Second_Parent_Play_Screen";
  @override
  _Second_Parent_Play_ScreenState createState() => _Second_Parent_Play_ScreenState();
}

class _Second_Parent_Play_ScreenState extends State<Second_Parent_Play_Screen> {
                  ...
                  children: [
                    ...
                    Column(
                      children: List.generate(widget.songs_list!.length, (index) =>   ListTile(
                          ...
                          child: InkWell(
                            ...
                            onTap: () async {
                              ...
                              await Hive.openBox('songs').then((value) {
                                ...
                                songsBox
                                    .put(widget.songs_list![widget.current_index!].album, {
                                  'status': true,
                                  'songs': mysongslist,
                                  'album_pic': widget.songs_list![widget.current_index!].albumArt
                                });
                        ...
                        leading: widget.songs_list![widget.current_index!].artist ==
                            index.toString()
                            ? Container(
                            decoration: BoxDecoration(
                        ...
                        title: widget.songs_list![widget.current_index!].artist ==
                            index.toString()
                            ? Text(
              ...
              children: [
                ...
                Column(
                    children: List.generate(widget.songs_list!.length, (index) =>         ListTile(
                      contentPadding: EdgeInsets.only(left: 20),
                      onTap: () async {
                        print("step1"+index.toString());
                        print("step2"+current_song_index.toString());
